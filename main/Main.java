...
import pizza.SaborForm;
import tipo.TipoForm;
import tipo.TipoForm;
/**
 *
 * @author lgehlen
...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btSabores.setText("GERENCIAR SABORES");
        btSabores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSaboresActionPerformed(evt);
            }
        });
        panelMenu.add(btSabores);
        btSabores.setBounds(10, 100, 280, 50);
    ...
    private void btValoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btValoresActionPerformed
        new TipoForm(this).setVisible(true);
        //this.setEnabled(false);
    ...
    private void btSaboresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSaboresActionPerformed
        new SaborForm(this).setVisible(true);
        //this.setEnabled(false);
